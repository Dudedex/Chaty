		...
		if($this->status)
		{
			...
			if($emailActivation == "true")
			{
				...
				$hooks = array(
					...
					"subjectStrs" => array($activation_message,$this->activation_token,$this->alias)
					);
			...
			if(!$this->mail_failure)
			{
				...
				$stmt->bind_param("sssssi", $this->username, $this->alias, $secure_pass, $this->clean_email, $this->activation_token, $this->user_active);
				$stmt->execute();
