...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_alias_IN_USE"		=> "Display name %m1% is already in use",
	...
	%m1%activate-devices.php?token=%m2%",
    ...
    "ACCOUNT_RSA_PUBLIC_KEY_UPDATED" => "Rsa public key updated",
	"ACCOUNT_RSA_PUBLIC_KEY_DELETED" => "Rsa public key deleted",
    "ACCOUNT_ALIAS_UPDATED" => "Display name (alias) updated",
	...
	"ACCOUNT_alias_UPDATED"		=> "alias changed to %m1%",
